...
class BundleAnalyzerPlugin {
    ...
    return _asyncToGenerator(function* () {
      if (_this2.server) {
        ...
        _this2.server = viewer.startServer(stats, {
          ...
          bundleDir: _this2.getBundleDir(_this2.opts.bundleDirOption),
  ...
  generateStaticReport(stats) {
    ...
    return _asyncToGenerator(function* () {
      yield viewer.generateReport(stats, {
        ...
        bundleDir: _this3.getBundleDir(_this3.opts.bundleDirOption),
  ...
  getBundleDir(bundleDirOption) {
    ...
    if (bundleDirOption == null) {
      return this.getBundleDirFromCompiler(); // bundleDirOption is explicitly turned off
